...
class Utils {
    ...
    static public function getDateFormating($actualite_date = "", $lang = "fr")
    {
        ...
        $date_format = Utils::jour_fr(date_format($datee, "l"), $lang) . " " . date_format($datee, "d") . " " . Utils::month_fr(date_format($datee, "F"), $lang) . " " . date_format($datee, "Y");
    ...
    static public function getDateFormatingsansday($actualite_date = "", $lang = "fr")
    {
        ...
        $date_format = date_format($datee, "d") . " " . Utils::month_fr(date_format($datee, "F"), $lang) . " " . date_format($datee, "Y");
